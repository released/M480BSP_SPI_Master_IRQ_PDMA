...
#line 441 "..\\..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 466 "..\\..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 491 "..\\..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 516 "..\\..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
uint8_t g_au8MasterToSlaveTestPattern[(8)]={0};
uint8_t g_au8MasterRxBuffer[(8)]={0};
...
void SPI_Master_PDMA_PreInit(void)
{
	...
	((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(1))) + ((2)<<2)))) = 0);

	( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_SPI_Transmit_end))) : ((BitFlag&=~(uint32_t)(1<<flag_SPI_Transmit_end))));
    ...
    PDMA_Open(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1 << (0)));

	
    PDMA_SetTransferCnt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(0), 0x00000000UL, (8));
     
    PDMA_SetTransferAddr(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(0), (uint32_t)g_au8MasterToSlaveTestPattern, 0x00000000UL, (uint32_t)&((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->TX, 0x00000C00UL);
     
    PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(0), 24UL, (0UL), 0);
     
    PDMA_SetBurstType(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(0), 0x00000004UL, 0);
     
    ((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[(0)].CTL |= (0x1ul << (7));

    ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->PDMACTL |= (0x1ul << (0)));

    PDMA_EnableInt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (0), 0x00000000UL);
...
void SPI_Master_PDMA_Enable(uint8_t TxRx)
{
	...
	if (TxRx == SPI_TX)
	{
		...
		g_au8MasterToSlaveTestPattern[(8)-1] = (uint8_t) 0x10*j;		
		j++;
...
void SPI1_IRQHandler(void)
{
	...
	if (((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->STATUS & (0x1ul << (16)))>>(16))) && (!( ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->STATUS & (0x1ul << (0)))>>(0) )))
    {
		( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_SPI_Transmit_end))) : ((BitFlag&=~(uint32_t)(1<<flag_SPI_Transmit_end))));
		SPI_DisableInt(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)), (0x080U));
...
{
    SPI_Open(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)), (0x0U), ((0x1ul << (2))), 8, (800000ul));

    SYS_UnlockReg();	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL &= ~( (0xful << (8)));	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL |=  (0x00UL<<(8));	
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),(0x00000004UL),0x1UL);	
    SYS_LockReg();	


    SPI_SetFIFO(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)), 3, 3);
...
{
    uint32_t status = ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->INTSTS));
	
    if (status & (0x1ul << (0)))    
    {

        ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->ABTSTS = (((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->ABTSTS)))));
#line 225 "..\\main.c"
    }
    else if (status & (0x1ul << (1)))      
    {
        if((((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & (1 << (0))) == (1 << (0)))
        {
             
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = ((1 << (0)))));

			
			( (((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->PDMACTL &= ~(0x1ul << (0)) );
			((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((1)<<2))))) ^= 1;
			
			SPI_EnableInt(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)), (0x080U));
        } 		
    }
    else if (status & ((0x1ul << (8)) | (0x1ul << (9))))      
    {
		((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((2)<<2))))) ^= 1;
        ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->INTSTS = (1 << (((0)) + 8))));
    }
    else
    {
...
void TMR1_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))) == 1)
    {
		...
		if ((get_tick() % 50) == 0)
		{
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_SPI_Transmit_timing))) : ((BitFlag&=~(uint32_t)(1<<flag_SPI_Transmit_timing))));
		}
		...
		{		
			...
			((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((0)<<2))))) ^= 1;
		}
    }
}
...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((1UL<<30)|(2UL<<28) |(0x3UL<<25) |(6UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(14UL<<0)), (0x2UL << (6)), 0x0UL);
    CLK_EnableModuleClock(((1UL<<30)|(2UL<<28) |(0x3UL<<25) |(6UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(14UL<<0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL &= ~((0xful << (16)) | (0xful << (20))| (0xful << (12))| (0xful << (8)));	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL |= (0x05UL<<(16)) | (0x05UL<<(20)) | (0x05UL<<(12)) | (0x05UL<<(8));

     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->SMTEN |= (0x1ul << (3));

     
    GPIO_SetSlewCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), 0xF, 0x1UL);
...
int main()
{
    ...
    while(1)
    {
		...
		if ((((BitFlag&(uint32_t)(1<<flag_SPI_Transmit_timing))?1:0)))	
		{
			( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_SPI_Transmit_timing))) : ((BitFlag&=~(uint32_t)(1<<flag_SPI_Transmit_timing))));

			if ((((BitFlag&(uint32_t)(1<<flag_SPI_Transmit_end))?1:0)))
			{
